...
#   $Revision: 1.8 $
#
#   $Id: application11.py,v 1.8 2003/09/06 16:35:15 brpreiss Exp $
#
...
class Application11(object):
    ...
    def weightedGraphTest(g):
        ...
        print g2
    weightedGraphTest = staticmethod(weightedGraphTest)
    ...
    def weightedDigraphTest(g):
        ...
        print g2
    weightedDigraphTest = staticmethod(weightedDigraphTest)
